...
public class TransactionRepository {
    ...
    public Payment savePayment(Payment payment) throws SQLException {
        String sql = "INSERT INTO payment (payement_date, amount, payment_methodes, payment_status) " +
                "VALUES (?, ?, ?, ?) RETURNING id";
        try (PreparedStatement pstmt = connection.getConnection().prepareStatement(sql)) {
    ...
    public Help saveHelp(Help help) throws SQLException {
        String sql = "INSERT INTO help (beneficiary_id, payment_id, accident_description) " +
                "VALUES (?, ?, ?) RETURNING id";
        try (PreparedStatement pstmt = connection.getConnection().prepareStatement(sql)) {
    ...
    public List<Donation> getAllDonations() throws SQLException {
        ...
        String sql = "SELECT d.id, d.donor_id, d.payment_id, " +
    ...
    public List<Help> getAllHelps() throws SQLException {
        ...
        String sql = "SELECT h.id, h.beneficiary_id, h.payment_id, h.accident_description, " +
        ...
        try (Statement stmt = connection.getConnection().prepareStatement(sql);
            ...
            while (rs.next()) {
                Donor beneficiary = Donor.builder()
