...
public class TransactionService {
  ...
  @Transactional
  public Donation processDonation(
      String email, String fullName, double amount, PaymentMethodes method) throws SQLException {
    Donor donor = repository.saveDonor(Donor.builder().email(email).fullName(fullName).build());
